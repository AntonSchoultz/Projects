...
public class ZipHelper
{
	...
	private final static Logger log = Logger.getLogger(ZipHelper.class);

	/**
	 * CONSTRUCTOR which accepts the zipFile specifier
	 * @param fZip File pointing to ZIP file
	 */
  ...
  public String[] readLines(String fileSpec)
  {
	 ...
	 * @param listFiles ArrayList<File> of files/directories to be added
	 * @throws Exception
	 */
